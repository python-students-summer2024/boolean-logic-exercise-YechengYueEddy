...
def is_sweltering():
    ...
    temp = int(input("What is the current temperature today (in Farenheit) ? "))
    return temp > 90
...
def is_humid():
    ...
    """
    # write your code for this function below this line.
    is_humid = input("Is it currently humid (answer yes or no) ? ").lower()
    return is_humid == "yes"
...
def is_inclement():
    ...
    """
    # write your code for this function below this line.
    forecast = input("What is the whether forecast tody? ").lower()
